...
export default function DashboardPage({ 
  ...
  const isGuestUser = currentUser?.isGuest || currentUser?.accountType === 'guest';
  ...
  const handleSendMessage = (e) => {
    ...
    const newMsg = {
      id: Date.now(),
      time: 'Just now',
      author: currentUser?.name || (isCurrentEmptyGuest ? 'Guest Client' : 'Omar Mohamed'),
...
Client: ${currentUser?.name || (isCurrentEmptyGuest ? 'Guest Client' : 'Omar Mohamed')}
Contract Date: ${isCurrentEmptyGuest ? 'Pending Scope Definition' : 'September 20, 2025'}
...
${currentUser?.name || (isCurrentEmptyGuest ? 'Guest Client' : 'Omar Mohamed')}`;
  ...
  return (
    <div className="min-h-screen w-full bg-[#03060E] text-slate-100 flex flex-col lg:flex-row overflow-hidden font-sans select-none">
      
      {/* ================= LEFT FULL-HEIGHT SIDEBAR matching Mockup ================= */}
      <aside className="w-full lg:w-64 bg-[#050A18] border-b lg:border-b-0 lg:border-r border-white/10 p-5 flex flex-col justify-between shrink-0 h-auto lg:h-screen sticky top-0 z-30">
        <div>
          {/* Top Brand Logo */}
          <div 
            onClick={() => {
        ...
        <div className="mt-6 p-4 rounded-2xl bg-gradient-to-br from-[#0A1124] to-[#0D1836] border border-white/10 relative overflow-hidden text-left shadow-md">
      ...
      <main className="flex-1 flex flex-col min-h-screen overflow-y-auto bg-[#030712] relative z-10">
        
        {/* TOP BREADCRUMB & USER BAR matching Mockup */}
        <header className="px-6 py-4 border-b border-white/10 flex flex-wrap items-center justify-between gap-4 shrink-0 bg-[#040814]/90 backdrop-blur-md sticky top-0 z-20">
          
          {/* Breadcrumb & Project View Selector */}
          <div className="flex items-center gap-2 text-xs font-mono text-slate-400">
            ...
            {/* Quick Switcher between Empty Guest Workspace, Sample E-Commerce, and Travel Platform */}
            <div className="hidden sm:inline-flex items-center p-0.5 ml-3 rounded-xl bg-white/5 border border-white/10 text-[10px]">
              <button
                onClick={() => {
                  soundEffects.playClick();
                  setSelectedProjectId('guest');
              ...
              <button
                ...
                className="px-3 py-1 rounded-lg transition-all font-mono text-slate-400 hover:text-white hover:bg-white/5"
              >
                Travel Platform (#A-7721) →
              </button>
            </div>
          </div>

          {/* Right: Notifications, User Profile & Return/Logout */}
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2.5 pl-2 border-l border-white/10">
              <img 
                src={currentUser?.avatar || (isCurrentEmptyGuest 
        ...
        <section className="p-6 sm:p-8 pb-4 relative overflow-hidden">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <div className="text-left space-y-1.5 max-w-2xl">
              ...
              <p className="text-xs sm:text-sm text-slate-400">
                {isCurrentEmptyGuest 
                  ? 'Welcome to your dedicated studio workspace. No project has been started yet. Define your requirements to launch your sprint.' 
          ...
          <div className="mt-8 pt-6 border-t border-white/10">
            <div className="grid grid-cols-5 gap-2 relative max-w-4xl mx-auto lg:mx-0">
        ...
        <section className="p-6 sm:p-8 pt-4 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 text-left flex-grow">
                ...
                {isCurrentEmptyGuest ? (
                  <>
                    ...
                    <div className="mt-4 p-3 rounded-xl bg-white/[0.02] border border-white/5 text-[11px] text-slate-400 leading-relaxed text-center">
                      No milestones in progress yet. Your roadmap tasks will unlock automatically upon kickoff.
                    </div>
                  </>
                ) : (
                  <>
